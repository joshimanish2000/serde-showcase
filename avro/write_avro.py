...
schema = avro.schema.parse(open("visit.avsc", "rb").read())

writer = DataFileWriter(open("visits.avro", "wb"), DatumWriter(), schema)
...
# reader = DataFileReader(open("visits.avro", "rb"), DatumReader())
# for user in reader:
#     print(f"{user}\n")
# reader.close()